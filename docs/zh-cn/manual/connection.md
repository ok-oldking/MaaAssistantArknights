...
- [雷电模拟器 9](https://help.ldmnq.com/) `emulator-5554`
...
需使用官版或方舟专版 MuMu 12 V4.0.0 及更新版本，并关闭 MuMu 后台保活。国际版等暂不支持。<!-- 官版 V3.8.13 -->
...
开启时，MuMu 模拟器标签页的顺序应为屏幕编号的序号，如 `0` 为模拟器桌面，`1` 为明日方舟客户端。

针对 MuMu 后台保活的适配非常不完善，总会出现各种各样莫名其妙的问题，非常不建议使用。

### 雷电截图增强模式

需使用官版雷电模拟器 9 V9.**<u>0</u>**.78 及更新版本。国际版，专版，9.1 测试版等暂不支持。

1. `设置` - `连接设置`，勾选 `启用 LD 截图增强模式`。
